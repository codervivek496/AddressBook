...
namespace AddressBook
{
    internal class MultipleAddressBook
    {
        ...
        {
            this.need = need;
            contactDetailsList = new List<ContactDetails>[need];
        ...
        public void AddingContactDetails()
        {
            ...
            int flag = 0;
            if (contactDetailsList[addressBookIndex].Count > 0)
            {
            ...
            {
                contactDetailsList[addressBookIndex].Add(details);
            }
        }
        ...
        public void SearchPersonByCity()
        {
            ...
            {
                int count = 0;
                foreach (ContactDetails details in contactDetailsList[count])
                {
